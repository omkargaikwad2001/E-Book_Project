...
<div class="col-md-3">
	...
	<c:if test="${not empty userobj}">
		<a href="login.jsp" class="btn btn-success"><i class="fa-solid fa-user-tie"></i> ${userobj.name}</a>
		<a data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-danger text-white"><i class="fa-solid fa-right-to-bracket mr-2"></i>LogOut</a>
	</c:if>
